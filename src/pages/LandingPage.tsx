            ...
            {pricingTiers.map((tier, index) => (
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  {tier.trialDays && (
                    <p className="text-sm text-green-600 dark:text-green-400 mt-1">
                      {tier.trialDays}-day free trial, then converts to Pro Artist
                    </p>
                  )}
                </div>
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  {tier.name === 'Starter' && <li className="flex items-start gap-2 text-gray-500"><Info className="w-5 h-5 text-orange-500 mt-0.5" /><span>Converts to Pro Artist after 30 days</span></li>}
                </ul>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-blue-700 text-white">
        <div className="container mx-auto max-w-7xl px-4 text-center">
          ...
          <p className="text-sm text-white/70 max-w-2xl mx-auto">
            Start with a 30-day free trial. After your trial period, your account will automatically convert to the Pro Artist plan at $59.99/month unless canceled.
          </p>
        </div>
      </section>
