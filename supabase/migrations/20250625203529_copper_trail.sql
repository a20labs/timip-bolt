-- Explicitly specify public schema to avoid permission errors
...
-- View for user subscriptions (with explicit schema)
...
-- View for user orders (with explicit schema and fixed WITH clause)
